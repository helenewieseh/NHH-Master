...
param optimal_distance_task_2a;                       #Optimal distance obtained in task 2a 
param max_5_percent := optimal_distance_task_2a * 1.05;
param max_10_percent := optimal_distance_task_2a * 1.10;
# =============================================================================================================
# Decision variables
# =============================================================================================================
...
# General constraints
# =============================================================================================================
# Ensure the total travel distance matches the optimal found in Task 2a
subject to TotalDistanceLimit:
    sum {t in TEAMS} travel[t] = optimal_distance_task_2a;
    
# Constraints for flexibility: 5% and 10% allowances
# 5% slacks
#subject to MaxTravelWith5Percent:
  #  sum {t in TEAMS} travel[t] <= max_5_percent;

# 10% slacks
#subject to MaxTravelWith5Percent:
    #sum {t in TEAMS} travel[t] <= max_10_percent;
