...
set MAIN_MATCHES within MATCHES; # Subset of main-seeded matches
...
param main_match_venue{MAIN_MATCHES} symbolic;  # Venue of seeded match s
...
# =============================================================================================================
# Objective function: Minimize total distance travelled by all teams
# =============================================================================================================
...
# Ensure main-seeded matches are scheduled at predefined venues
subject to MainSeededMatches {m in MAIN_MATCHES}:
    x[m, main_match_venue[m]] = 1;
